...
```sh
.venv/bin/python -m mikan_font_probe.adaptive_regions --version adaptive-v3 --annotations data/priority-a.json data/priority-b.json
.venv/bin/python -m mikan_font_probe.segment_text --version adaptive-v3 --annotations data/priority-a.json data/priority-b.json
.venv/bin/python -m mikan_font_probe.ctd_regions --version ctd-raw-v2 --model /path/to/comictextdetector.pt.onnx
.venv/bin/python -m mikan_font_probe.compare_overlays
.venv/bin/python -m unittest tests.test_adaptive_regions -v
```
