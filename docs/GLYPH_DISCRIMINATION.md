...
python3 \
  mikan_font_probe/build_glyph_discrimination.py \
  --output data/glyph-discrimination-v1 \
  --extra-chars data/active-selection-v1/characters.txt

PYTHONDONTWRITEBYTECODE=1 .venv/bin/python -m unittest -v tests.test_glyph_discrimination
```
