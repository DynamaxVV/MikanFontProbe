...
from mikan_font_probe.local_contour_matcher import compare, decide, local_loss, region_mask, template_evidence
...
class LocalContourTests(unittest.TestCase):
    ...
    def test_live_rerank_branch_and_clear_lead_guard(self):
        ...
        with patch("mikan_font_probe.rank_font_contours.compare", return_value=({"vote": -1}, None)), \
                patch("mikan_font_probe.rank_font_contours.template_evidence", return_value={
