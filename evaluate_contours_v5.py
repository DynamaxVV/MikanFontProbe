...
from geometry_font_matcher import GeometryReferences
from local_contour_matcher import POLICY, compare, template_evidence
...
def failure_image(sample, refs, result):
    ...
    for row in pair["evidence"]:
        ...
        src = normalize(imread(ROOT/glyph["path"]))
