...
from stroke_feature_matcher import FEATURE_POLICY, FeatureReferences, gray_canvas, pair_features
...
def main():
    ...
    write_json(output/"freeze.json", {"code": {p: hashlib.sha256((ROOT/p).read_bytes()).hexdigest() for p in code},
