...
from mikan_font_probe.stroke_correspondence_v7 import (CORRESPONDENCE_POLICY, FeatureReferences,
...
def main():
    from mikan_font_probe.closed_box_features import BOX_POLICY
    ...
    freeze = {"code": {p: hashlib.sha256((resolve_repo_path(p)).read_bytes()).hexdigest() for p in code},
