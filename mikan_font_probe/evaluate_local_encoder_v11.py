...
from mikan_font_probe.train_local_encoder_v11 import CATALOG_PATH, TEMPLATE_DIR, tight_gray, augment
...
def main() -> None:
    ...
    output = {"status": "font_only_encoder_real_crop_evaluation", "device": str(device),
              ...
              "notes": ["Templates and real crops share the encoder; no real crop was used for training.",
                        ...
                        "Folder categories are mapped to the question-bank answers, while raw categories remain in each row.",
